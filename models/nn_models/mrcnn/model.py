...
class MaskRCNN():
    ...
    def compile(self, learning_rate, momentum):
        ...
        for name in loss_names:
            ...
            if layer.output in added_loss_name:
                continue
            loss = (
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_checkpoint.h5")
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.EarlyStopping(monitor='val_loss', patience=1000,
                                            verbose=0),
